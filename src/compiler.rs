...
pub const HEADERS: &[(&str, &str)] = &[
    (
        "stdio.h",
        include_str!("../../sw-cor24-x-tinyc/include/stdio.h"),
    ),
    (
        "stdlib.h",
        include_str!("../../sw-cor24-x-tinyc/include/stdlib.h"),
    ),
    (
        "string.h",
        include_str!("../../sw-cor24-x-tinyc/include/string.h"),
    ),
    (
        "cor24.h",
        include_str!("../../sw-cor24-x-tinyc/include/cor24.h"),
    ),
    (
        "stdbool.h",
        include_str!("../../sw-cor24-x-tinyc/include/stdbool.h"),
    ),
];
